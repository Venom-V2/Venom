...
data = {
{
{text = '{ أوامر ألحمايه }', data = msg.sender.user_id..'/help1'}, {text = '{ أوامر ألادمنيه }', data = msg.sender.user_id..'/help2'}, 
},
{
{text = '{ أوامر ألمدراء }', data = msg.sender.user_id..'/help3'}, {text = '{ أوامر ألمنشئين }', data = msg.sender.user_id..'/help4'}, 
},
{
{text = '{ أوامر ألمطورين }', data = msg.sender.user_id..'/help5'}, {text = '{ الالعاب }', data = msg.sender.user_id..'/help6'}, 
},
{
...
if text == (Redis:get(Revor.."Revor:Name:Bot") or "فينوم") then
local NamesBot = (Redis:get(Revor.."Revor:Name:Bot") or "فينوم")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
data = {
{
{text = 'أوامر ألحمايه » { 👊 }', data = '/Mahibes1'}, {text = 'أوامر ألادمنيه » { 👊 }', data = '/Mahibes2'}, 
},
{
{text = 'أوامر ألمدراء » { 👊 }', data = '/Mahibes3'}, {text = 'أوامر ألمنشئين » { 👊 }', data = '/Mahibes4'}, 
},
{
{text = 'أوامر ألمطورين » { 👊 }', data = '/Mahibes5'}, {text = '𝟔 » { 👊 }', data = '/Mahibes6'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
Redis:set(Revor.."Revor:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط', 'رفع مطور')
Redis:set(Revor.."Revor:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر', 'ردود المدير')
Redis:set(Revor.."Revor:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح', 'مسح سحكاتي')
Redis:set(Revor.."Revor:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي', 'رفع مطور ثانوي')
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(Revor.."Revor:Name:Bot") or "فينوم")..
...
{
{text = 'تغييركليشه المطور ᥀',type = 'text'},{text = 'حذف كليشه المطور ᥀', type = 'text'},
},
{
...
if text == 'تغييركليشه المطور ᥀' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
data = {
{
{text = 'أوامر ألحمايه » { '..Mahibes1..' }', data = '/*'}, {text = 'أوامر ألادمنيه » { '..Mahibes2..' }', data = '/*'}, 
},
{
{text = 'أوامر ألمدراء » { '..Mahibes3..' }', data = '/*'}, {text = 'أوامر ألمنشئين » { '..Mahibes4..' }', data = '/*'}, 
},
{
{text = 'أوامر ألمطورين » { '..Mahibes5..' }', data = '/*'}, {text = '𝟔 » { '..Mahibes6..' }', data = '/*'}, 
},
{
...
data = {
{
{text = '{ أوامر ألحمايه }', data = IdUser..'/help1'}, {text = '{ أوامر ألادمنيه }', data = IdUser..'/help2'}, 
},
{
{text = '{ أوامر ألمدراء }', data = IdUser..'/help3'}, {text = '{ أوامر ألمنشئين }', data = IdUser..'/help4'}, 
},
{
{text = '{ أوامر ألمطورين }', data = IdUser..'/help5'}, {text = '{ الالعاب }', data = IdUser..'/help6'}, 
},
{
