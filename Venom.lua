...
ControllerAll = false
local ListSudos ={Sudo_Id,2032996533}  
...
TheBasicsQ = Redis:sismember(Venom.."Venom:TheBasicsQ:Group"..ChatId,UserId) 
...
Status = Redis:get(Venom.."Venom:PresidentQ:Group:Reply"..ChatId) or 'المالك'
...
ktmall = Redis:sismember(Venom.."Venom:ktmAll:Groups",UserId) ,
...
if tonumber(msg.sender.user_id) == 2032996533 then
...
elseif Redis:sismember(Venom.."Venom:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Venom.."Venom:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
...
if text and Redis:get(Venom.."Venom:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Venom.."Venom:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Venom.."Venom:All:Get:Reides:Commands:Group"..text)
Redis:del(Venom.."Venom:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Venom.."Venom:All:Command:List:Group",text)
...
Redis:del(Venom.."Venom:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Venom.."Venom:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Venom.."Venom:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Venom.."Venom:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Venom.."Venom:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Venom.."Venom:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Venom.."Venom:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Venom.."Venom:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Venom.."Venom:All:Command:List:Group",text)
Redis:del(Venom.."Venom:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
if Redis:get(Venom.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Venom.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
...
if Redis:get(Venom.."Venom:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Venom.."Venom:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Venom.."Venom:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Venom.."Venom:Set:Id:Groups",text:match("(.*)"))
...
if text then
local NewCmmd = Redis:get(Venom.."Venom:All:Get:Reides:Commands:Group"..text) or Redis:get(Venom.."Venom:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/venom_source'}, },}}
...
Redis:sadd(Venom.."Venom:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Venom.."Venom:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Venom.."Venom:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Venom.."Venom:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Venom.."Venom:TheBasics:Group"..idg,idASAS)
end;end
end
...
--download('https://raw.githubusercontent.com/Venom-V2/Venom/master/Venom.lua','Venom.lua')
...
Redis:del(Venom.."Venom:SendBcBot") 
...
Redis:set(Venom.."Venom:SendBcBot",true) 
...
Redis:set(Venom.."Venom:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Venom.."Venom:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر ᥀' then   
Redis:del(Venom.."Venom:AddSudosNew"..msg_chat_id)
...
Redis:set(Venom.."Venom:AddSudosNew"..msg_chat_id,true)
...
Get_Is_Id = Redis:get(Venom.."Venom:Set:Id:Groups") or Redis:get(Venom.."Venom:Set:Id:Group"..msg_chat_id)
...
local TotalMsg = Redis:get(Venom..'Venom:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Venom..'Venom:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Venom.."Venom:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Venom.."Venom:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if not Redis:sismember(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Venom.."Venom:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:del(Venom.."Venom:PresidentQ:Group:Reply"..msg.chat_id)
...
local Info_Members = Redis:smembers(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Venom.."Venom:ktmAll:Groups") 
if #Info_Members == 0 then
...
if TextMsg == 'التحقق' then
    Redis:set(Venom.."Venom:Status:joinet"..msg_chat_id,true) 
...
Redis:set(Venom.."Venom:Status:remMe"..msg_chat_id,true) 
...
if TextMsg == 'التحقق' then
    Redis:del(Venom.."Venom:Status:joinet"..msg_chat_id) 
...
if TextMsg == 'نزلني' then
Redis:del(Venom.."Venom:Status:remMe"..msg_chat_id) 
...
if Redis:sismember(Venom.."Venom:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Venom.."Venom:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Venom.."Venom:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Venom.."Venom:ktmAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Venom.."Venom:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Venom.."Venom:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Venom.."Venom:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Venom.."Venom:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if text == "نزلني" then
if not Redis:get(Venom.."Venom:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Venom.."Venom:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Venom.."Venom:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Venom.."Venom:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Venom.."Venom:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Venom.."Venom:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Venom.."Venom:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Venom.."Venom:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Venom.."Venom:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Venom.."Venom:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Venom.."Venom:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(Venom.."Venom:LeftBot") then
...
Redis:setex(Venom.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
Redis:set(Venom.."Venom:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Venom.."Venom:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Venom.."Venom:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Venom.."Venom:All:Get:Reides:Commands:Group"..v)
Redis:del(Venom.."Venom:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Venom.."Venom:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:setex(Venom.."Venom:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل الان النص
᥀︙يمكنك اضافه :
...
Redis:del(Venom.."Venom:Set:Id:Groups")
...
Redis:del(Venom.."Venom:ktmAll:Groups") 
...
if not msg.ControllerBot and not Redis:set(Venom.."Venom:SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/venom_source'}, },}}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/venom_source'}, 
},
{
{text = 'Exp Source', url = 't.me/venom_source'}, 
},
{
...
if text == (Redis:get(Venom.."Venom:Name:Bot") or "السلطان") then
local NamesBot = (Redis:get(Venom.."Venom:Name:Bot") or "السلطان")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(Venom.."Venom:Name:Bot") or "السلطان")..
...
{
{text = '- قناة السورس', url = 't.me/venom_source'}, {text = '- مطور السورس', url = 't.me/wKwvv'}, 
},
}
}
...
Redis:del(Venom.."Venom:List:Manager"..'-100'..data.supergroup.id)
Redis:del(Venom.."Venom:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Venom..'Venom:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
{
{text = 'اوامر المطورين » { '..Mahibes5..' }', data = '/*'}, {text = '𝟔 » { '..Mahibes6..' }', data = '/*'}, 
},
{
...
{
{text = 'اوامر المطورين » { 👊 }', data = '/Mahibes5'}, {text = '𝟔 » { 👊 }', data = '/Mahibes6'}, 
},
}
}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Venom.."Venom:TheBasicsQ:Group"..ChatId) 
